  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _loadingWarehouses
          ...
          : _warehousesError != null
              ? AppErrorView(
                  message: _warehousesError!, onRetry: _loadWarehouses)
              : ListView(
                  ...
                  children: [
                    ...
                    if (_items.isNotEmpty) ...[
                      const SizedBox(height: 16),
                      const Text('نوع التسوية المالية',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                      RadioListTile<String>(
                        value: 'none',
                        groupValue: _settlementType,
                        title: const Text('بدون تسوية — تحديث المخزون فقط',
                      ...
                      RadioListTile<String>(
                        value: 'treasury',
                        groupValue: _settlementType,
                        title: const Text('تسوية على الخزينة',
                            style: TextStyle(fontSize: 13)),
                        onChanged: (v) {
                      ...
                      RadioListTile<String>(
                        value: 'customer',
                        groupValue: _settlementType,
                        title: const Text('تسوية على مديونية عميل',
                            style: TextStyle(fontSize: 13)),
                        onChanged: (v) {
                          setState(() => _settlementType = v!);
                          _loadSettlementRefData();
                      ...
                      if (_settlementType == 'customer')
                        DropdownButtonFormField<int>(
                          ...
                          decoration:
                              const InputDecoration(labelText: 'العميل'),
                          items: _customers
